    ...
    */
    ...
    function isOperatorValid(oper){
        console.log("O Parametro "+oper+" é um operador?", oper.valueOf() === '+' ||  oper.valueOf() === '-' ||  oper.valueOf() === '*' ||  oper.valueOf() === '/' ||  oper.valueOf() === '%' )
    }
    /*
    ...
    function calculator (oper){
        if(oper != '+' && oper != '-' && oper != '/' && oper != '*' && oper != '%' ){
            ...
            return function operacao (a, b) {
                ...
                switch (oper) {
                    case '+':
                    return operation.soma(a, b);
                    break;
                    case '-':
                    return operation.subtracao(a, b);
                    break;
                    case '*':
                    return operation.multiplicacao(a, b);
                    break;
                    case '/': 
                    return operation.divisao(a, b);
                    break;
                    case '%': 
    ...
    */
    ...
    function showOperationMessage (oper, num1, num2) {
        return "A operacao "+num1+" "+oper+" "+num2+" = ";
    }
    /*
    ...
    */
    ...
    function showErrorMessage (oper){
        if(oper != '+' && oper != '-' && oper != '/' && oper != '*' && oper != '%' ){
            return "Operacao "+oper+" nao permitida!"
            }
    }
    /*
    ...
    */
    ...
    if (subtraction === false){subtraction
        console.log(showErrorMessage(operationSignal));
    } else {
